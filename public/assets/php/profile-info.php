            ...
            <div id="artist"> <!--div nghệ sĩ-->
                <div id="main-artist">
                   ...
                   SELECT nguoidung.MaNguoiDung, nguoidung.TenNguoiDung, nguoidung.AnhNguoiDung, danhsachphat.TenDSP 
                    ...
                    WHERE nguoidung.MaNguoiDung=1";
                    $result = mysqli_query($conn, $sql);
                    $row = mysqli_fetch_assoc($result);
                    ?>

                    <span id="avatar-profile" style=" background-color:transparent; background-image: url('<?php echo $row["AnhNguoiDung"]; ?>');">
                        <span style="cursor: pointer; color: white; font-size: 16px; font-weight: 600;" id="button-change-avt">
                    ...
                    <div class="info-artist">
                        ...
                        <div id="artist-follower"><span style="color: #8B8B8B;"; id="artist-count-playlist"><?php echo $row["Dem"] ?> danh sách phát. &nbsp</span>123.456.789 người theo dõi</div>
                    </div>
                </div>
                <div id="play">
                    ...
                    <div id ="songs">
                            ...
                            if ($result->num_rows > 0) {
                                ...
                                while($row = $result->fetch_assoc()) {
                                    ...
                                    echo '<div id="song1">';
                                    echo '<span id="heart-icon2"><i class="fa-solid fa-heart"></i></span>';
                ...
                <div id="artist-follow">
                    ...
                    <div id="artist-following-list">
                        <div id="artist-following-each">
                            <span><img src="../img/artist5.png" alt="Amee"><br></span>
                            <span id="name-artist-following">AMEE</span>
                        </div>
                        <div id="artist-following-each">
                            <span><img src="../img/artist5.png" alt="Amee"><br></span>
                            <span id="name-artist-following">AMEE</span>
